...
3. 已存在的 lifecycle_*.md 文件不受新规则影响（历史归档）
...
| 时间戳 | world_time | age | energy | speed | x | y | follow | mouth | 备注 |
|--------|------------|-----|--------|-------|---|---|--------|-------|------|
| 2026-05-01T | 22478 | 0.07 | 65.30 | 20.0 | -1442.68 | 891.70 | 0.112 | 1.0 | 新目标142521 gen=150 |